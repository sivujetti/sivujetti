...
final class ThemesController {
    ...
    /**
     * @param string $mediaScopeId
     * @return bool
     */
    private static function mediaScopeCssHasChanged(string $mediaScopeId): bool {
        return true; // Todo check that $previoslyStoredHash !== hash(new)
    }
    /**
