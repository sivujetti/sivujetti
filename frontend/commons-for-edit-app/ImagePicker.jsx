...
import {Icon, PathIcon} from './Icon.jsx';
...
class ImagePicker extends preact.Component {
    ...
    // unregistrables;
    /**
     * @param {{onSrcCommitted: (newSrc: string|null, mime: string|null, srcWasTyped: boolean) => void; src: string|null; inputId: string; omitClearButton?: boolean; showClearItem?: boolean; inputSize?: 'tight';}} props
     */
    constructor(props) {
        super(props);
        ...
        if (src !== undefined) {
            ...
            return <div class="flex-centered">
                ...
                <button
                    ...
                    class="btn btn-sm btn-primary flex-centered ml-1"
                    style={ `height: ${this.props.inputSize === 'tight' ? '1.54' : '1.7'}rem` }
                    type="button">
                    <PathIcon className="tabler-folder-open size-xs">
