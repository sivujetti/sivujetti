    ...
    public static function getThemeStyles(): array {
        return [(object) [
            "units" => json_encode([["title" => "Default", "scss" => "margin:0 auto;&> [data-block-root]{padding: 4rem 2rem}",
                "compiledCss" => ".j-Section-default{margin:0 auto;}.j-Section-default>[data-block-root]{padding:4rem 2rem;}"]]),
            "themeId" => "1",
            "blockTypeName" => "Section",
        ], (object) [
            "units" => json_encode([["title" => "Default", "scss" => "font-size: 1rem", "compiledCss" =>
