...
return [
    ...
    'blocks' => [
        ...
        ['data' => [8,'','columns','main','kuura:generic-wrapper',3,NULL],
         'props' => [[11,'foo','bar',8]],
         'children' => [
             ['data' => [9,'8/','section','<inner>','kuura:generic-wrapper',6,NULL],
              'props' => [[12,'cssClass','light',9],],
              'children' => [
                  ['data' => [10,'8/9/','heading','<inner>','kuura:auto',6,NULL],
                   'props' => [[13,'text','Services',10],
                               [14,'level','1',10],],
                   'children' => []],
                  ['data' => [11,'8/9/','dynamic-listing','<inner>','kuura:auto',6,'Services'],
                   'props' => [[15,'fetchFilters','{"$all": {"$eq": {"pageType": "Services"}}}',11],],
                   'children' => []],
              ]],
             ['data' => [12,'8/','section','<inner>','kuura:generic-wrapper',6,NULL],
              'props' => [[16,'cssClass','aside-column',12],],
              'children' => [
                  ['data' => [13,'8/12/','heading','<inner>','kuura:auto',6,NULL],
                   'props' => [[17,'text','Sidebar2',13],
                               [18,'level','2',13],],
                   'children' => []],
                  ['data' => [14,'8/12/','paragraph','<inner>','kuura:auto',6,NULL],
