    ...
    render({src, inputId, omitClearButton}, {values}) {
        if (src !== undefined) {
            ...
            return <div class="flex-centered">
                ...
                <button onClick={ this.openPickerDialog.bind(this) } class="btn btn-sm btn-primary ml-1"
                    style="padding-top: .36rem; height: 1.6rem; transform: translateY(-1px)" type="button">
