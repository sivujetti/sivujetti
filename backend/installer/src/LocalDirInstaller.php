...
final class LocalDirInstaller {
     ...
     * @param array{db.driver: string, db.database: string, baseUrl: string, mainQueryVar: string, secret: string, initialUserUsername: string, initialUserEmail: string, initialUserPasswordHash: string, flags: string} $config
     */
