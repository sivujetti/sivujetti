...
// ##         }),
         ...
         * @param {'dev-styles-tab'} origin = null
         */
        (visibleBlock, unitCls, origin = null) => {
            focusToBlockAndEmitBlockTreeClick(visibleBlock, 'styles-tab', () => {
                ...
                const fromStyleUnits = origin !== 'dev-styles-tab';
                const tabLinkSelector = fromStyleUnits ? '.tab-item-user-styles' : '.tab-item-dev-styles' ;
                // Open styles tab
