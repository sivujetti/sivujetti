 ...
 * @psalm-type StyleChunk = object{scss: string, scope: object{kind: styleScopeKind, layer: stylesLayer, page?: string}, data?: object{title?: string, mutationRules?: object{varDefs: array<int, todo>, associatedBlockTypes?: array<int, string>}}}
