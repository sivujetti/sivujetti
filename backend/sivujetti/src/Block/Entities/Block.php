 ...
 * @psalm-type StyleChunk = object{scss: string, scope: object{kind: styleScopeKind, layer: stylesLayer}, data?: object{title?: string, mutationRules?: object{varDefs: array<int, todo>}}}
