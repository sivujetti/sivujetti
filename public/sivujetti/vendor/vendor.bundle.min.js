// https://unpkg.com/browse/history@4.10.1/umd/history.min.js
...
// https://unpkg.com/browse/preact@10.8.2/hooks/dist/hooks.umd.js
...
// storeon
var storeon=function(t){"use strict";return t.createStoreon=t=>{let e={},c={},i={dispatch(t,n){if("@dispatch"!==t&&i.dispatch("@dispatch",[t,n,e[t]]),e[t]){let r;e[t].forEach((a=>{let o=e[t].includes(a)&&a(c,n,i);o&&"function"!=typeof o.then&&(c={...c,...o},r={...r,...o})})),r&&i.dispatch("@changed",r)}},get:()=>c,on:(t,c)=>((e[t]||(e[t]=[])).push(c),()=>{e[t]=e[t].filter((t=>t!==c))})};return t.forEach((t=>{t&&t(i)})),i.dispatch("@init"),i},Object.defineProperty(t,"__esModule",{value:!0}),t}({});
