...
stringBundles.push({
    ...
    'Diagnose issues': 'Tarkasta sivuston tila',
    ...
    'Diagnose': 'Tarkasta sivuston tila',
    'The check detected the following issues:': 'Tarkastuksessa havaittiin seuraavat ongelmat:',
    'The check found no issues.': 'Tarkastus ei havainnut ongelmia.',
    'Backend directory is publicly accessible': 'Backend-kansio on julkisesti saatavilla',
    'The backend directory is currently accessible through the web browser. This is fine during development, but remember to move it outside of the public web root directory when deploying to production to prevent unauthorized access to sensitive files.': 'Backend-kansio on tällä hetkellä saavutettavissa verkkoselaimen kautta. Tämä on OK localhostissa, mutta muista siirtää kansio julkisen web-juurihakemiston ulkopuolelle kun siirrät sivuston tuotantopalvelimellesi.',
    'The backend directory is currently accessible through the web browser, which poses a security risk. It should be moved outside of the public web root directory to prevent unauthorized access to sensitive files.': 'Backend-kansio on tällä hetkellä saavutettavissa verkkoselaimen kautta, mikä aiheuttaa tietoturvariskin. Se tulisi siirtää julkisen web-juurihakemiston ulkopuolelle pääsyn estämiseksi.',
    'Xdebug is enabled': 'Xdebug on käytössä',
    'Xdebug php extension is currently enabled while display_errors is also on. This configuration should not be used in production environments as it can expose sensitive information.': 'Xdebug PHP-laajennus on käytössä samalla kun display_errors -asetus on päällä. Tätä yhdistelmää ei tulisi käyttää tuotantoympäristössä, sillä se voi paljastaa arkaluontoista tietoa.',
    'Website is hidden from search engines': 'Sivusto ei näy hakukoneille',
    'The website is currently hidden from search engines even though search engine indexing is enabled in the site settings. This is caused by Site.php or a plugin modifying the <head> section markup. You can resolve this issue by removing the markup-modifying filter from Site.php or the relevant plugin.': 'Sivusto ei tällä hetkellä näy hakukoneille, vaikka hakukoneiden indeksointi on sallittu sivuston asetuksissa. Tämä johtuu siitä, että Site.php tai jokin lisäosa muokkaa <head>-osion markupia. Voit korjata ongelman poistamalla markupia muokkaavan suodattimen Site.php:sta tai kyseisestä lisäosasta.',
    'The website is currently hidden from search engines in the site settings. If you want your site to be discoverable, you can change this setting in the form found under \'%s (%s) > %s\'.': 'Sivusto on tällä hetkellä piilotettu hakukoneilta sivuston asetuksissa. Jos haluat sivustosi olevan löydettävissä, salli sivuston indeksointi \'%s (%s) > %s\' -linkistä avautuvassa lomakkeessa.',
    'File conflict detected': 'Tiedostokonflikti havaittu',
    'A static index.html file was found on the server which overrides the default index.php file. This prevents the page editing functionality from working properly. You can resolve this issue by removing or renaming the conflicting file.': 'Palvelimelta löytyi staattinen index.html-tiedosto, joka ohittaa index.php -oletustiedoston. Tämä estää sivun muokkauksen toimimasta normaalisti. Voit korjata ongelman poistamalla tai nimeämällä uudelleen konfliktin aiheuttavan tiedoston.',
